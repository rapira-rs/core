bind! {
    ...
    // consts
    SAPI_HEADER_SENT_SUCCESSFULLY, SAPI_HEADER_SEND_FAILED, TRACK_VARS_FILES, IS_UNDEF, IS_STRING, // diagnostic types; E_CORE and E_FATAL_ERRORS are php-src's own groupings

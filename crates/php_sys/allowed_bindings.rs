bind! {
    ...
    RAPIRA_RECV_OK, RAPIRA_RECV_TIMEOUT, RAPIRA_RECV_EMPTY, RAPIRA_RECV_CLOSED, RAPIRA_RECV_BUSY,
    RAPIRA_VERB_OK, RAPIRA_VERB_FINALIZED, RAPIRA_VERB_HEAD_WRITTEN, RAPIRA_VERB_INTERIM,
    RAPIRA_VERB_INVALID, RAPIRA_VERB_OVERFLOW,
